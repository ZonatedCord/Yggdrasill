...
PiantaSmart's iOS app is a fork of [Moustachauve/WLED-iOS](https://github.com/Moustachauve/WLED-iOS) (GPL v3), restyled with **Apple's Liquid Glass** design language (iOS 26).
